...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        %>
          ...
          <tr>
            <td class="leftmenu_td_link"><a href="SubjectCategory.do?subjectID=<%=subjectID%>&resourceCategoryID=11&orderChapter=<%=orderChapter%>"><bean:message  key="text.menu.video"/></a></td>
          </tr>
          <tr>
            <td >&nbsp;</td>
          </tr>
