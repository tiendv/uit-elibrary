...
<html>
    ...
    <body>
        ...
        %>
        <a href= "LoadSubject.do"><bean:message key="text.menu.subject"/></a> > 
        <%if(language==1) {%>
        ...
        <table>
            <thead>
                <tr>
                    <%if(language==1) {%>
                        <th colspan="2" style="color:#680a12;font-size: 30px "><%=subject.getSubjectName()%></th>
                    <%}%>
                    <%if(language==2) {%>
            ...
            <tbody>
                ...
                <tr>
                    <td><b><bean:message key="text.creditNumber"/>:</b> <%=subject.getCreditNumber()%></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><b><bean:message key="text.courceCode"/>:</b> <%=subject.getCreditNumber()%></td>
                </tr>
                <tr>
        ...
        <%if(language==1) {%>
            <div style="padding-left: 8px;font-weight: bold"><bean:message key="text.introductionSubject"/>:</div> <div style="padding-left: 8px"><%=subject.getSubjectIntroduce()%></div>
        <%}%>    
        <%if(language==2) {%>
            <div style="padding-left: 8px;font-weight: bold"><bean:message key="text.introductionSubject"/>:</div> <div style="padding-left: 8px"><%=subject.getSubjectIntroduceVn()%></div>
        <%}%>   
    </body>
</html>
