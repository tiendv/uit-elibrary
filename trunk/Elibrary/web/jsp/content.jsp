...
<div class="divcontent">
    ...
    <div class="table_advertising">
        ...
        <div>
            <div><img src="image/uit.png" width="218px" /></div>
        </div>
        <div>
            <div><img src="image/isatd.png"  width="218px" /></div>
        </div>
        <div>
            <div><img src="image/ntt.png" width="218px" /></div>
        </div>
        <div>
            <div><img src="image/stu.png" width="218px" /></div>
        </div>
        <div>
            <div><img src="image/duytan.png" width="218px"/></div>
        </div>
    </div>      
</div>
