...
insert  into `subject`(`SubjectID`,`SubjectCategoryID`,`SpecialityID`,`SubjectName`,`SubjectIntroduce`,`CreditNumber`,`Level`,`PeriodOfTheory`,`PeriodOfPractice`,`CourseCode`,`Teacher`,`PrerequisiteSubject`,`MidtermGrade`,`FinalGrade`,`SubjectNameVN`,`SubjectIntroduceVN`,`TimeTeaching`,`ProjectRequitement`,`ProjectRequitementUS`) values (9,1,1,'','',NULL,'',0,0,'','','',0,0,'','','','',''),(10,1,1,'','',NULL,'',0,0,'','','',0,0,'','','','','');
