 ...
 */
public class EditResourceForm extends org.apache.struts.action.ActionForm {
    ...
    public void setFileSyllabus(FormFile fileSyllabus) {
        this.fileSyllabus = fileSyllabus;
    }
